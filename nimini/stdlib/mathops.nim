...
proc nimini_abs*(env: ref Env; args: seq[Value]): Value =
...
# Min/Max functions
proc nimini_min*(env: ref Env; args: seq[Value]): Value =
...
proc nimini_max*(env: ref Env; args: seq[Value]): Value =
