...
/* Command for C compiler:
   gcc -c  -w -fmax-errors=3 -fno-strict-aliasing -pthread -I/workspaces/telestorie/lib   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_sdl3_test/@mlib@slayerfx.nim.c.o /workspaces/telestorie/nimcache_sdl3_test/@mlib@slayerfx.nim.c */
...
{	result.len = 0; result.p = NIM_NIL;
	...
	{
		nimln_(456);		nimlf_(1699, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system.nim");		eqcopy___system_u2710((&result), (*v_p0).s);
		goto BeforeRet_;
	}
	break;
	default:
...
{	result = (NI)0;
	...
	{
		nimln_(445);		nimln_(442);		nimln_(445);		if ((((NI) ((*v_p0).f))) < ((NI)(IL64(-9223372036854775807) - IL64(1))) || (((NI) ((*v_p0).f))) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI(((NI) ((*v_p0).f)), ((NI)(IL64(-9223372036854775807) - IL64(1))), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
		}
		result = (((NI) ((*v_p0).f)));
		goto BeforeRet_;
	}
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___libZlayerfx_u1278)(tyObject_LayerEffects__PP7a11Q9bHdTSkrDxYpd2mA* dest_p0, tyObject_LayerEffects__PP7a11Q9bHdTSkrDxYpd2mA* src_p1) {
	...
	eqcopy___system_u2710((&(*dest_p0).displacementEffect), (*src_p1).displacementEffect);
...
N_LIB_PRIVATE N_NIMCALL(NI, colonanonymous___libZlayerfx_u2828)(tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* a_p0, tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* b_p1) {
	...
	result = cmp__system_u8494((*a_p0).z, (*b_p1).z);
	popFrame();
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_LayerEffects__PP7a11Q9bHdTSkrDxYpd2mA*, getEffects__libZlayerfx_u1810)(NimStringV2 layerId_p0) {
...
LA6_: ;
		if (!T3_) goto LA8_;
		nimln_(339);		compositeLayers__srcZlayers_u2310(state_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
LA12_: ;
	nimln_(347);	clear__backendsZterminalZtermbuffer_u325((&(*state_p0).currentBuffer), (*state_p0).themeBackground);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	sort__srcZlayers_u2328((((*state_p0).layers).p) ? ((*state_p0).layers.p->data) : NIM_NIL, (*state_p0).layers.len, T14_, ((tyEnum_SortOrder__4o9bu23mZL49azIuH2sugcuQ)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ** layer_1;
		NI i_1;
...
LA22_: ;
					...
					nimln_(360);					{
						...
						nimln_(362);						compositeBufferOnto__backendsZterminalZtermbuffer_u364((&(*state_p0).currentBuffer), (&(*(*layer_1)).buffer));
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					}
					goto LA24_;
LA26_: ;
...
LA46_: ;
													...
													eqcopy___backendsZterminalZtermbuffer_u110((&cell_1), (&(*(*layer_1)).buffer.cells.p->data[srcIdx_1]));
...
LA72_: ;
														...
														eqsink___backendsZterminalZtermbuffer_u116((&(*state_p0).currentBuffer.cells.p->data[destIdx_1]), (&cell_1));
														eqwasMoved___backendsZterminalZtermbuffer_u104((&cell_1));
													}
LA74_: ;
													{
														LA37_:;
													...
													{
														eqdestroy___backendsZterminalZtermbuffer_u107((&cell_1));
													}
...
{nimErr_ = nimErrorFlag();
	nimlf_(93, "/workspaces/telestorie/lib/layerfx.nim");	{
		...
		nimlf_(110, "/workspaces/telestorie/src/layers.nim");		nimZeroMem((void*)(&T6_), sizeof(tyProc__bCvtH5ozdDDqkD8FYCmuQg));
		T6_.ClP_0 = ((TM__nritKQ4cdCISbkFaJ9a3wVg_63) (compositeLayersWithEffects__libZlayerfx_u40)); T6_.ClE_0 = NIM_NIL;
		eqsink___srcZlayers_u2659((&gCompositeHook__libZlayerfx_u33), T6_);
	}
LA3_: ;
	}BeforeRet_: ;
	popFrame();
