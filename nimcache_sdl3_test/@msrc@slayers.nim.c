...
/* Command for C compiler:
   gcc -c  -w -fmax-errors=3 -fno-strict-aliasing -pthread -I/workspaces/telestorie/lib   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_sdl3_test/@msrc@slayers.nim.c.o /workspaces/telestorie/nimcache_sdl3_test/@msrc@slayers.nim.c */
...
typedef N_CLOSURE_PTR(void, TM__S7JoVEI2sNQ6bM1nRx3HAQ_10) (tyObject_AppStatecolonObjectType___jrSyZ9aZLwUQnIb5lEtzv8Q* state_p0);
typedef struct {
...
typedef N_CLOSURE_PTR(NI, TM__S7JoVEI2sNQ6bM1nRx3HAQ_11) (tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* x_p0, tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* y_p1, void* ClE_0);
...
N_LIB_PRIVATE N_NIMCALL(NI, colonanonymous___srcZlayers_u2318)(tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* a_p0, tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* b_p1);
...
} TM__S7JoVEI2sNQ6bM1nRx3HAQ_3 = { 149 | NIM_STRLIT_FLAG, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system/iterators.nim(254, 11) `len(a) == L` the length of the seq changed while iterating over it" };
static const NimStringV2 TM__S7JoVEI2sNQ6bM1nRx3HAQ_4 = {149, (NimStrPayload*)&TM__S7JoVEI2sNQ6bM1nRx3HAQ_3};
static const struct {
  NI cap; NIM_CHAR data[7+1];
} TM__S7JoVEI2sNQ6bM1nRx3HAQ_5 = { 7 | NIM_STRLIT_FLAG, "default" };
static const NimStringV2 TM__S7JoVEI2sNQ6bM1nRx3HAQ_6 = {7, (NimStrPayload*)&TM__S7JoVEI2sNQ6bM1nRx3HAQ_5};
static const struct {
  NI cap; NIM_CHAR data[149+1];
} TM__S7JoVEI2sNQ6bM1nRx3HAQ_7 = { 149 | NIM_STRLIT_FLAG, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system/iterators.nim(187, 11) `len(a) == L` the length of the seq changed while iterating over it" };
static const NimStringV2 TM__S7JoVEI2sNQ6bM1nRx3HAQ_8 = {149, (NimStrPayload*)&TM__S7JoVEI2sNQ6bM1nRx3HAQ_7};
static const NimStringV2 TM__S7JoVEI2sNQ6bM1nRx3HAQ_12 = {149, (NimStrPayload*)&TM__S7JoVEI2sNQ6bM1nRx3HAQ_3};
static const NimStringV2 TM__S7JoVEI2sNQ6bM1nRx3HAQ_13 = {149, (NimStrPayload*)&TM__S7JoVEI2sNQ6bM1nRx3HAQ_3};
N_LIB_PRIVATE tyProc__bCvtH5ozdDDqkD8FYCmuQg gCompositeHook__srcZlayers_u2309;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ*, addLayer__srcZlayers_u2140)(tyObject_AppStatecolonObjectType___jrSyZ9aZLwUQnIb5lEtzv8Q* state_p0, NimStringV2 id_p1, NI z_p2) {
	...
	NI colontmpD__2;
	tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* colontmpD__3;
	tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* T2_;
NIM_BOOL* nimErr_;
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(74);	T2_ = NIM_NIL;
	T2_ = (tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ*) nimNewObjUninit(sizeof(tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ), NIM_ALIGNOF(tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ));
	nimln_(75);	nimlf_(1699, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system.nim");	colontmpD_ = eqdup___system_u2713(id_p1);
	(*T2_).id = colontmpD_;
	nimlf_(76, "/workspaces/telestorie/src/layers.nim");	colontmpD__2 = z_p2;
	(*T2_).z = colontmpD__2;
	(*T2_).visible = NIM_TRUE;
	nimln_(78);	newTermBuffer__backendsZterminalZtermbuffer_u4((*state_p0).termWidth, (*state_p0).termHeight, (&(*T2_).buffer));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	layer_1 = T2_;
	nimln_(80);	clearTransparent__backendsZterminalZtermbuffer_u340((&(*layer_1).buffer));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimln_(81);	nimln_(23);	colontmpD__3 = eqdup___srcZlayers_u82(layer_1);
	nimln_(81);	add__srcZlayers_u2146((&(*state_p0).layers), colontmpD__3);
	nimln_(82);	invalidateLayerCache__srcZlayers_u1963(state_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimln_(83);	nimln_(73);	nimln_(83);	result = layer_1;
...
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	{
		...
		L_1 = T2_;
		{
			nimln_(251);			while (1) {
				if (!(i_1 < L_1)) goto LA4;
				nimlf_(86, "/workspaces/telestorie/src/layers.nim");				if (i_1 < 0 || i_1 >= (*state_p0).layers.len){ raiseIndexError2(i_1,(*state_p0).layers.len-1); goto BeforeRet_;
				}
				layer_1 = &(*state_p0).layers.p->data[i_1];
				nimln_(87);				{
					if (!eqStrings((*(*layer_1)).id, id_p1)) goto LA7_;
					nimln_(88);					nimln_(23);					eqcopy___srcZlayers_u79(&result, (*layer_1));
					goto BeforeRet_;
				}
LA7_: ;
				...
				nimln_(254);				{
					...
					failedAssertImpl__stdZassertions_u234(TM__S7JoVEI2sNQ6bM1nRx3HAQ_4);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				}
LA12_: ;
			} LA4: ;
	...
	nimlf_(89, "/workspaces/telestorie/src/layers.nim");	nimln_(85);	nimln_(89);	result = ((tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ*) NIM_NIL);
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
	return result;
		...
		L_1 = T2_;
		{
			nimln_(184);			while (1) {
				...
				nimln_(187);				{
					...
					failedAssertImpl__stdZassertions_u234(TM__S7JoVEI2sNQ6bM1nRx3HAQ_8);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				}
LA8_: ;
			} LA4: ;
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(52);	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = eqStrings(layerId_p1, TM__S7JoVEI2sNQ6bM1nRx3HAQ_6);
		if (T3_) goto LA4_;
	...
	nimln_(92);	i_1 = ((NI)0);
	{
		nimln_(93);		while (1) {
			...
			nimln_(94);			{
				...
				nimln_(95);				if ((i_1) < ((NI)0) || (i_1) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI(i_1, ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
				}
				delete__srcZlayers_u2218((&(*state_p0).layers), (i_1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimln_(96);				invalidateLayerCache__srcZlayers_u1963(state_p0);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			}
			goto LA4_;
LA6_: ;
			{
				NI TM__S7JoVEI2sNQ6bM1nRx3HAQ_9;
				nimln_(98);				if (nimAddInt(i_1, ((NI)1), &TM__S7JoVEI2sNQ6bM1nRx3HAQ_9)) { raiseOverflow(); goto BeforeRet_;
				};
				i_1 = (NI)(TM__S7JoVEI2sNQ6bM1nRx3HAQ_9);
			}
LA4_: ;
		} LA2: ;
	}
...
N_LIB_PRIVATE N_NIMCALL(NI, colonanonymous___srcZlayers_u2318)(tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* a_p0, tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* b_p1) {
	...
	nimln_(128);	result = cmp__system_u8494((*a_p0).z, (*b_p1).z);
	popFrame();
	return result;
}
static N_INLINE(void, nimSetMem__systemZmemory_u7)(void* a_p0, int v_p1, NI size_p2) {
...
{nimErr_ = nimErrorFlag();
	nimln_(114);	{
		if (!!((gCompositeHook__srcZlayers_u2309.ClP_0 == 0))) goto LA3_;
		nimln_(115);		gCompositeHook__srcZlayers_u2309.ClE_0? gCompositeHook__srcZlayers_u2309.ClP_0(state_p0, gCompositeHook__srcZlayers_u2309.ClE_0):((TM__S7JoVEI2sNQ6bM1nRx3HAQ_10)(gCompositeHook__srcZlayers_u2309.ClP_0))(state_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimln_(116);		goto BeforeRet_;
	}
LA3_: ;
	nimln_(119);	{
		NI T7_;
...
LA8_: ;
	nimln_(123);	clear__backendsZterminalZtermbuffer_u325((&(*state_p0).currentBuffer), (*state_p0).themeBackground);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimln_(127);	nimZeroMem((void*)(&T10_), sizeof(tyProc__ijtkaENAqyRwfv9bZK9cSOuA));
	T10_.ClP_0 = ((TM__S7JoVEI2sNQ6bM1nRx3HAQ_11) (colonanonymous___srcZlayers_u2318)); T10_.ClE_0 = NIM_NIL;
	sort__srcZlayers_u2328((((*state_p0).layers).p) ? ((*state_p0).layers.p->data) : NIM_NIL, (*state_p0).layers.len, T10_, ((tyEnum_SortOrder__4o9bu23mZL49azIuH2sugcuQ)1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimln_(130);	invalidateLayerCache__srcZlayers_u1963(state_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ** layer_1;
		NI i_1;
		...
		L_1 = T12_;
		{
			nimln_(251);			while (1) {
				...
				nimlf_(132, "/workspaces/telestorie/src/layers.nim");				if (i_1 < 0 || i_1 >= (*state_p0).layers.len){ raiseIndexError2(i_1,(*state_p0).layers.len-1); goto BeforeRet_;
				}
				layer_1 = &(*state_p0).layers.p->data[i_1];
				nimln_(133);				{
					if (!(*(*layer_1)).visible) goto LA17_;
					nimln_(134);					compositeBufferOnto__backendsZterminalZtermbuffer_u364((&(*state_p0).currentBuffer), (&(*(*layer_1)).buffer));
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				}
LA17_: ;
				nimlf_(13, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system/iterators.nim");				i_1 += ((NI)1);
				nimln_(254);				{
					...
					failedAssertImpl__stdZassertions_u234(TM__S7JoVEI2sNQ6bM1nRx3HAQ_12);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				}
LA22_: ;
			} LA14: ;
...
{nimErr_ = nimErrorFlag();
	{
		...
		L_1 = T2_;
		{
			nimln_(251);			while (1) {
				...
				if (!(i_1 < L_1)) goto LA4;
				nimlf_(102, "/workspaces/telestorie/src/layers.nim");				if (i_1 < 0 || i_1 >= (*state_p0).layers.len){ raiseIndexError2(i_1,(*state_p0).layers.len-1); goto BeforeRet_;
				}
				layer_1 = &(*state_p0).layers.p->data[i_1];
				nimln_(27);				nimln_(103);				nimZeroMem((void*)(&T5_), sizeof(tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw));
				...
				nimln_(104);				clearTransparent__backendsZterminalZtermbuffer_u340((&(*(*layer_1)).buffer));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimlf_(13, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system/iterators.nim");				i_1 += ((NI)1);
				nimln_(254);				{
					NI T8_;
					...
					failedAssertImpl__stdZassertions_u234(TM__S7JoVEI2sNQ6bM1nRx3HAQ_13);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				}
LA9_: ;
			} LA4: ;
...
N_LIB_PRIVATE N_NIMCALL(void, atmsrcatslayersdotnim_Init000)(void) {
{
	...
	nimlf_(110, "/workspaces/telestorie/src/layers.nim");	gCompositeHook__srcZlayers_u2309.ClE_0 = TM__S7JoVEI2sNQ6bM1nRx3HAQ_2.ClE_0;
	gCompositeHook__srcZlayers_u2309.ClP_0 = TM__S7JoVEI2sNQ6bM1nRx3HAQ_2.ClP_0;
	nimTestErrorFlag();
	popFrame();
}
}
