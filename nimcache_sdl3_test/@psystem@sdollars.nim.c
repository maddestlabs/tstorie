...
/* Command for C compiler:
   gcc -c  -w -fmax-errors=3 -fno-strict-aliasing -pthread -I/workspaces/telestorie/lib   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_sdl3_test/@psystem@sdollars.nim.c.o /workspaces/telestorie/nimcache_sdl3_test/@psystem@sdollars.nim.c */
...
static N_INLINE(void, addFloat__system_u4956)(NimStringV2* result_p0, NF x_p1);
...
} TM__n49a9aYp5BrbXv9a6OCpJYm0g_8 = { 149 | NIM_STRLIT_FLAG, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system/iterators.nim(254, 11) `len(a) == L` the length of the seq changed while iterating over it" };
...
{nimErr_ = nimErrorFlag();
	nimlf_(142, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/std/formatfloat.nim");	addFloatRoundtrip__system_u4961(result_p0, x_p1);
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(15);	addFloat__system_u4956((&result), x_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
	return result;
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(1699, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system.nim");	eqcopy___system_u2710((&result), prefix_p1);
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	nimln_(133);	result = collectionToString__libZstorie95md_u3458(x_p0, TM__n49a9aYp5BrbXv9a6OCpJYm0g_11, TM__n49a9aYp5BrbXv9a6OCpJYm0g_13, TM__n49a9aYp5BrbXv9a6OCpJYm0g_15);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
	return result;
