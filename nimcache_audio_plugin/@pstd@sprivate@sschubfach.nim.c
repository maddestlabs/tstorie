...
/* Command for C compiler:
   gcc -c  -w -fmax-errors=3 -fno-strict-aliasing -pthread -Os -fno-ident  -fPIC  -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie/lib -o /workspaces/telestorie/nimcache_audio_plugin/@pstd@sprivate@sschubfach.nim.c.o /workspaces/telestorie/nimcache_audio_plugin/@pstd@sprivate@sschubfach.nim.c */
...
N_LIB_PRIVATE NIM_CONST tyArray__ocdlWeLAycDNOOtB9cadACA g__stdZprivateZschubfach_u97 = {9353610478917778677ULL,
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Single__y6RpMOCM3k6J7RVJs3Z9csQ, constructSingle__stdZprivateZschubfach_u50)(NF32 value_p0) {
	tyObject_Single__y6RpMOCM3k6J7RVJs3Z9csQ result;
	NU32 colontmpD_;
	union { NF32 source; NU32 dest; } LOC1;
	nimZeroMem((void*)(&result), sizeof(tyObject_Single__y6RpMOCM3k6J7RVJs3Z9csQ));
	colontmpD_ = (NU32)0;
