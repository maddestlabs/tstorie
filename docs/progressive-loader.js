 ...
 * 
 * Strategy:
 * 1. App starts with minimal iosevka-startup.ttf (33KB, bundled in WASM)
 * 2. After 2 seconds (app is interactive), load iosevka-full.ttf (1.4MB)
      ...
      setTimeout(() => {
        try {
          ...
          if (Module._emReloadFontSDL3) {
            ...
            const ptr = allocateUTF8(fontPath);
