...
function getShaderConfig() {
    return {
        ...
        fragmentShader: `
            ...
            vec3 Blur(vec2 tex_coord, float sigma, float borderSize, float hWave) {
                ...
                for (int x = 0; x < BLOOM_SAMPLES; x++) {
                    ...
                    for (int y = 0; y < BLOOM_SAMPLES; y++) {
                        ...
                        vec2 adjustedPos = (samplePos - vec2(borderSize, borderSize)) / (1.0 - 2.0 * borderSize);
                ...
                if (isFrame) {
                    ...
                    if (contentUV.x < 0.0 || contentUV.x > 1.0 || contentUV.y < 0.0 || contentUV.y > 1.0) {
                        ...
                        if (bloomLevel > 0.0) {
                            ...
                            vec3 bloom = Blur(contentUV, scaledGaussianSigma, border, hWave);
