...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -sUSE_SDL=3 -I/workspaces/storie-vendor/vendor/SDL_ttf-src/include -Os   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_wasm_sdl3/@mbackends@sterminal@stermbuffer.nim.c.o /workspaces/telestorie/nimcache_wasm_sdl3/@mbackends@sterminal@stermbuffer.nim.c */
...
} TM__YUEZm6l2D5ui6TQWDCivXQ_28 = { 43 | NIM_STRLIT_FLAG, "[TermBuffer] ERROR: Negative dimensions! w=" };
static const NimStringV2 TM__YUEZm6l2D5ui6TQWDCivXQ_29 = {43, (NimStrPayload*)&TM__YUEZm6l2D5ui6TQWDCivXQ_28};
static const struct {
  NI cap; NIM_CHAR data[3+1];
} TM__YUEZm6l2D5ui6TQWDCivXQ_30 = { 3 | NIM_STRLIT_FLAG, " h=" };
static const NimStringV2 TM__YUEZm6l2D5ui6TQWDCivXQ_31 = {3, (NimStrPayload*)&TM__YUEZm6l2D5ui6TQWDCivXQ_30};
static const NimStringV2 TM__YUEZm6l2D5ui6TQWDCivXQ_33 = {1, (NimStrPayload*)&TM__YUEZm6l2D5ui6TQWDCivXQ_24};
static const NimStringV2 TM__YUEZm6l2D5ui6TQWDCivXQ_35 = {0, (NimStrPayload*)&TM__YUEZm6l2D5ui6TQWDCivXQ_2};
static const NimStringV2 TM__YUEZm6l2D5ui6TQWDCivXQ_41 = {1, (NimStrPayload*)&TM__YUEZm6l2D5ui6TQWDCivXQ_24};
static const NimStringV2 TM__YUEZm6l2D5ui6TQWDCivXQ_43 = {1, (NimStrPayload*)&TM__YUEZm6l2D5ui6TQWDCivXQ_24};
static const NimStringV2 TM__YUEZm6l2D5ui6TQWDCivXQ_46 = {1, (NimStrPayload*)&TM__YUEZm6l2D5ui6TQWDCivXQ_24};
...
LA30_: ;
		...
		eqsink___backendsZsdl3Zsdl95canvas_u269((&(*tb_p0).cells.p->data[idx_1]), T33_);
	}
LA31_: ;
	}BeforeRet_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(void, newTermBuffer__backendsZterminalZtermbuffer_u4)(NI w_p0, NI h_p1, tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw* Result) {
	...
	tySequence__hETDgeXECLenIIi9aRQgjOA T11_;
...
LA4_: ;
		...
		T8_[0] = TM__YUEZm6l2D5ui6TQWDCivXQ_29;
		colontmpD_ = dollar___systemZdollars_u14(w_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
		T8_[1] = colontmpD_;
		T8_[2] = TM__YUEZm6l2D5ui6TQWDCivXQ_31;
...
LA5_: ;
	(*Result).width = w_p0;
	(*Result).height = h_p1;
	if (nimMulInt(w_p0, h_p1, &TM__YUEZm6l2D5ui6TQWDCivXQ_32)) { raiseOverflow(); goto BeforeRet_;
	};
	if (((NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_32)) < ((NI)0) || ((NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_32)) > ((NI)2147483647)){ raiseRangeErrorI((NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_32), ((NI)0), ((NI)2147483647)); goto BeforeRet_;
	}
	T11_.len = 0; T11_.p = NIM_NIL;
	T11_ = newSeq__backendsZsdl3Zsdl95canvas_u177(((NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_32)));
	eqsink___backendsZsdl3Zsdl95canvas_u323((&(*Result).cells), T11_);
	(*Result).clipX = ((NI)0);
	(*Result).clipY = ((NI)0);
	(*Result).clipW = w_p0;
	(*Result).clipH = h_p1;
	...
	defaultStyle_1.bold = NIM_FALSE;
	{
		...
		i_1 = (NI)0;
		colontmp_ = (NI)0;
		T13_ = (*Result).cells.len;
		colontmp_ = T13_;
		i_2 = ((NI)0);
		{
			while (1) {
				tyObject_Style__UURjArTrf2wmcCbN5MncAQ colontmpD__3;
				tyObject_Cell__cmvwxiDU9cRtyqddD9c1iMTA T16_;
				...
				T16_.ch = TM__YUEZm6l2D5ui6TQWDCivXQ_33;
				colontmpD__3 = eqdup___srcZtypes_u76(defaultStyle_1);
				T16_.style = colontmpD__3;
				eqsink___backendsZsdl3Zsdl95canvas_u269((&(*Result).cells.p->data[i_1]), T16_);
				if (nimAddInt(i_2, ((NI)1), &TM__YUEZm6l2D5ui6TQWDCivXQ_34)) { raiseOverflow(); goto BeforeRet_;
				};
				i_2 = (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_34);
			} LA15: ;
		}
	}
	}BeforeRet_: ;
	...
	defaultStyle_1.bold = NIM_FALSE;
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				...
				T5_.ch = TM__YUEZm6l2D5ui6TQWDCivXQ_35;
				colontmpD_ = eqdup___srcZtypes_u76(defaultStyle_1);
				T5_.style = colontmpD_;
				eqsink___backendsZsdl3Zsdl95canvas_u269((&(*tb_p0).cells.p->data[i_1]), T5_);
				if (nimAddInt(i_2, ((NI)1), &TM__YUEZm6l2D5ui6TQWDCivXQ_36)) { raiseOverflow(); goto BeforeRet_;
				};
				i_2 = (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_36);
			} LA4: ;
		}
	}
	}BeforeRet_: ;
		...
		i_1 = ((NI)0);
		{
			while (1) {
				...
				dy_1 = i_1;
				{
					...
					{
						while (1) {
							NI TM__YUEZm6l2D5ui6TQWDCivXQ_37;
							NI TM__YUEZm6l2D5ui6TQWDCivXQ_38;
							NI TM__YUEZm6l2D5ui6TQWDCivXQ_39;
							if (!(i_2 < w_p3)) goto LA6;
							dx_1 = i_2;
							if (nimAddInt(x_p1, dx_1, &TM__YUEZm6l2D5ui6TQWDCivXQ_37)) { raiseOverflow(); goto BeforeRet_;
							};
							if (nimAddInt(y_p2, dy_1, &TM__YUEZm6l2D5ui6TQWDCivXQ_38)) { raiseOverflow(); goto BeforeRet_;
							};
							write__backendsZterminalZtermbuffer_u49(tb_p0, (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_37), (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_38), ch_p5, style_p6);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							if (nimAddInt(i_2, ((NI)1), &TM__YUEZm6l2D5ui6TQWDCivXQ_39)) { raiseOverflow(); goto BeforeRet_;
							};
							i_2 = (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_39);
						} LA6: ;
					}
				}
				if (nimAddInt(i_1, ((NI)1), &TM__YUEZm6l2D5ui6TQWDCivXQ_40)) { raiseOverflow(); goto BeforeRet_;
				};
				i_1 = (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_40);
			} LA3: ;
		}
	}
	}BeforeRet_: ;
	...
	defaultStyle_1.bold = NIM_FALSE;
	{
		...
		i_2 = ((NI)0);
		{
			while (1) {
				tyObject_Style__UURjArTrf2wmcCbN5MncAQ colontmpD_;
				tyObject_Cell__cmvwxiDU9cRtyqddD9c1iMTA T5_;
				NI TM__YUEZm6l2D5ui6TQWDCivXQ_42;
				if (!(i_2 < colontmp_)) goto LA4;
				nimZeroMem((void*)(&colontmpD_), sizeof(tyObject_Style__UURjArTrf2wmcCbN5MncAQ));
				i_1 = i_2;
				if (i_1 < 0 || i_1 >= (*tb_p0).cells.len){ raiseIndexError2(i_1,(*tb_p0).cells.len-1); goto BeforeRet_;
				}
				T5_.ch = TM__YUEZm6l2D5ui6TQWDCivXQ_41;
				colontmpD_ = eqdup___srcZtypes_u76(defaultStyle_1);
				T5_.style = colontmpD_;
				eqsink___backendsZsdl3Zsdl95canvas_u269((&(*tb_p0).cells.p->data[i_1]), T5_);
				if (nimAddInt(i_2, ((NI)1), &TM__YUEZm6l2D5ui6TQWDCivXQ_42)) { raiseOverflow(); goto BeforeRet_;
				};
				i_2 = (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_42);
			} LA4: ;
		}
	}
	}BeforeRet_: ;
...
LA9_: ;
		...
		colontmp__2 = TM__YUEZm6l2D5ui6TQWDCivXQ_43;
...
LA10_: ;
	if (nimMulInt(y_p2, (*tb_p0).width, &TM__YUEZm6l2D5ui6TQWDCivXQ_44)) { raiseOverflow(); goto LA1_;
	};
	if (nimAddInt((NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_44), x_p1, &TM__YUEZm6l2D5ui6TQWDCivXQ_45)) { raiseOverflow(); goto LA1_;
	};
	idx_1 = (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_45);
	{
		NIM_BOOL T17_;
		NI T19_;
...
LA20_: ;
	...
	colontmp_ = TM__YUEZm6l2D5ui6TQWDCivXQ_46;
	...
	h_1 = (((*dest_p0).height <= (*src_p1).height) ? (*dest_p0).height : (*src_p1).height);
	{
		...
		i_1 = ((NI)0);
		{
			while (1) {
				...
				NI TM__YUEZm6l2D5ui6TQWDCivXQ_52;
				if (!(i_1 < h_1)) goto LA3;
				y_1 = i_1;
				if (nimMulInt(y_1, (*dest_p0).width, &TM__YUEZm6l2D5ui6TQWDCivXQ_47)) { raiseOverflow(); goto BeforeRet_;
				};
				dr_1 = (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_47);
				if (nimMulInt(y_1, (*src_p1).width, &TM__YUEZm6l2D5ui6TQWDCivXQ_48)) { raiseOverflow(); goto BeforeRet_;
				};
				sr_1 = (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_48);
				{
					NI x_1;
					NI i_2;
					x_1 = (NI)0;
					i_2 = ((NI)0);
					{
						while (1) {
							...
							x_1 = i_2;
							if (nimAddInt(sr_1, x_1, &TM__YUEZm6l2D5ui6TQWDCivXQ_49)) { raiseOverflow(); goto BeforeRet_;
							};
							if ((NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_49) < 0 || (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_49) >= (*src_p1).cells.len){ raiseIndexError2((NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_49),(*src_p1).cells.len-1); goto BeforeRet_;
							}
							eqcopy___backendsZsdl3Zsdl95canvas_u263((&s_1), (*src_p1).cells.p->data[(NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_49)]);
							{
								NIM_BOOL T9_;
								NIM_BOOL T11_;
								NIM_BOOL T12_;
...
LA10_: ;
								if (!T9_) goto LA15_;
								if (nimAddInt(dr_1, x_1, &TM__YUEZm6l2D5ui6TQWDCivXQ_50)) { raiseOverflow(); goto BeforeRet_;
								};
								if ((NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_50) < 0 || (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_50) >= (*dest_p0).cells.len){ raiseIndexError2((NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_50),(*dest_p0).cells.len-1); goto BeforeRet_;
								}
								eqsink___backendsZsdl3Zsdl95canvas_u269((&(*dest_p0).cells.p->data[(NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_50)]), s_1);
								eqwasMoved___backendsZsdl3Zsdl95canvas_u257((&s_1));
							}
LA15_: ;
							if (nimAddInt(i_2, ((NI)1), &TM__YUEZm6l2D5ui6TQWDCivXQ_51)) { raiseOverflow(); goto BeforeRet_;
							};
							i_2 = (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_51);
							eqdestroy___backendsZsdl3Zsdl95canvas_u260((&s_1));
						} LA6: ;
					}
				}
				if (nimAddInt(i_1, ((NI)1), &TM__YUEZm6l2D5ui6TQWDCivXQ_52)) { raiseOverflow(); goto BeforeRet_;
				};
				i_1 = (NI)(TM__YUEZm6l2D5ui6TQWDCivXQ_52);
			} LA3: ;
		}
	}
	}BeforeRet_: ;
