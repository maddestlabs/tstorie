...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -sUSE_SDL=3 -I/workspaces/storie-vendor/vendor/SDL_ttf-src/include -Os   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_wasm_sdl3/@msrc@slayers.nim.c.o /workspaces/telestorie/nimcache_wasm_sdl3/@msrc@slayers.nim.c */
...
typedef N_CLOSURE_PTR(void, TM__S7JoVEI2sNQ6bM1nRx3HAQ_23) (tyObject_AppStatecolonObjectType___jrSyZ9aZLwUQnIb5lEtzv8Q* state_p0);
typedef struct {
...
typedef N_CLOSURE_PTR(NI, TM__S7JoVEI2sNQ6bM1nRx3HAQ_24) (tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* x_p0, tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* y_p1, void* ClE_0);
...
static const NimStringV2 TM__S7JoVEI2sNQ6bM1nRx3HAQ_25 = {90, (NimStrPayload*)&TM__S7JoVEI2sNQ6bM1nRx3HAQ_16};
...
{nimErr_ = nimErrorFlag();
	{
		...
		gCompositeHook__srcZlayers_u2346.ClE_0? gCompositeHook__srcZlayers_u2346.ClP_0(state_p0, gCompositeHook__srcZlayers_u2346.ClE_0):((TM__S7JoVEI2sNQ6bM1nRx3HAQ_23)(gCompositeHook__srcZlayers_u2346.ClP_0))(state_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		goto BeforeRet_;
	}
LA3_: ;
...
LA8_: ;
	...
	T10_.ClP_0 = ((TM__S7JoVEI2sNQ6bM1nRx3HAQ_24) (colonanonymous___srcZlayers_u2355)); T10_.ClE_0 = NIM_NIL;
...
LA17_: ;
				i_1 += ((NI)1);
				{
					...
					failedAssertImpl__stdZassertions_u234(TM__S7JoVEI2sNQ6bM1nRx3HAQ_25);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				}
LA22_: ;
			} LA14: ;
