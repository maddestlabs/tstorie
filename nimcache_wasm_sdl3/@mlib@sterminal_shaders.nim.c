...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -sUSE_SDL=3 -I/workspaces/storie-vendor/vendor/SDL_ttf-src/include -Os   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_wasm_sdl3/@mlib@sterminal_shaders.nim.c.o /workspaces/telestorie/nimcache_wasm_sdl3/@mlib@sterminal_shaders.nim.c */
...
LA19_: ;
								...
								if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
								eqdestroy___backendsZsdl3Zsdl95canvas_u560((&srcCell_1));
							}
LA20_: ;
...
LA53_: ;
										...
										if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
										eqdestroy___backendsZsdl3Zsdl95canvas_u560((&srcCell_2));
									}
LA54_: ;
								}
LA22_: ;
								eqdestroy___backendsZsdl3Zsdl95canvas_u560((&dispCell_1));
							}
LA15_: ;
...
LA94_: ;
									...
									if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
									eqdestroy___backendsZsdl3Zsdl95canvas_u560((&srcCell_3));
								}
LA95_: ;
								eqdestroy___backendsZsdl3Zsdl95canvas_u560((&dispCell_2));
							}
LA70_: ;
...
{	nimZeroMem((void*)(&result), sizeof(tyObject_Cell__cmvwxiDU9cRtyqddD9c1iMTA));
	...
	nimZeroMem((void*)(&colontmpD__3), sizeof(tyObject_Color__TZLGUfQjHRBnaB3m3yIxqQ));
	{
		...
		eqcopy___backendsZsdl3Zsdl95canvas_u263((&result), inCell_p0);
		goto BeforeRet_;
	}
LA3_: ;
