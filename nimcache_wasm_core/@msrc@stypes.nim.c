...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -sUSE_SDL=3 -Os   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_wasm_core/@msrc@stypes.nim.c.o /workspaces/telestorie/nimcache_wasm_core/@msrc@stypes.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Style__UURjArTrf2wmcCbN5MncAQ, defaultStyle__srcZtypes_u65)(void) {
	tyObject_Style__UURjArTrf2wmcCbN5MncAQ result;
{	result = gGlobalDefaultStyle__srcZtypes_u64;
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___srcZlayers_u44)(tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* dest_p0) {
	eqdestroy___backendsZsdl3Zsdl95canvas_u248((*dest_p0).buffer.cells);
...
N_LIB_PRIVATE N_NIMCALL(void, setGlobalDefaultStyle__srcZtypes_u95)(tyObject_Style__UURjArTrf2wmcCbN5MncAQ style_p0) {
	gGlobalDefaultStyle__srcZtypes_u64 = style_p0;
}
static N_INLINE(NI, minuspercent___system_u813)(NI x_p0, NI y_p1) {
	NI result;
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___srcZappstate_u37)(tyObject_AppStatecolonObjectType___jrSyZ9aZLwUQnIb5lEtzv8Q* dest_p0) {
 ...
 dealloc((*dest_p0).inputParser.utf8Buffer.p);
}
	eqdestroy___srcZlayers_u896((*dest_p0).layerIndexCache.data);
	eqdestroy___srcZlayers_u1837((*dest_p0).layers);
	eqdestroy___backendsZsdl3Zsdl95canvas_u248((*dest_p0).previousBuffer.cells);
	eqdestroy___backendsZsdl3Zsdl95canvas_u248((*dest_p0).currentBuffer.cells);
}
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___srcZlayers_u25)(tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw* dest_p0, tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw* src_p1) {
	...
	if ((*dest_p0).cells.p != (*src_p1).cells.p) {	eqdestroy___backendsZsdl3Zsdl95canvas_u248((*dest_p0).cells);
	}
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___srcZlayers_u19)(tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw* dest_p0, tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw* src_p1) {
	(*dest_p0).width = (*src_p1).width;
	(*dest_p0).height = (*src_p1).height;
	eqcopy___backendsZsdl3Zsdl95canvas_u251((&(*dest_p0).cells), (*src_p1).cells);
	(*dest_p0).clipX = (*src_p1).clipX;
	(*dest_p0).clipY = (*src_p1).clipY;
	(*dest_p0).clipW = (*src_p1).clipW;
	(*dest_p0).clipH = (*src_p1).clipH;
...
{nimErr_ = nimErrorFlag();
	nimZeroMem((void*)(&result), sizeof(tyObject_Color__TZLGUfQjHRBnaB3m3yIxqQ));
	result = rgb__srcZtypes_u16(level_p0, level_p0, level_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
