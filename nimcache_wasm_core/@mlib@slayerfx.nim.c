...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -sUSE_SDL=3 -Os   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_wasm_core/@mlib@slayerfx.nim.c.o /workspaces/telestorie/nimcache_wasm_core/@mlib@slayerfx.nim.c */
...
LA46_: ;
													...
													eqcopy___backendsZsdl3Zsdl95canvas_u197((&cell_1), (*(*layer_1)).buffer.cells.p->data[srcIdx_1]);
													{
														NIM_BOOL T50_;
														NIM_BOOL T51_;
														NIM_BOOL T52_;
...
LA72_: ;
														...
														eqsink___backendsZsdl3Zsdl95canvas_u203((&(*state_p0).currentBuffer.cells.p->data[destIdx_1]), cell_1);
														eqwasMoved___backendsZsdl3Zsdl95canvas_u191((&cell_1));
													}
LA74_: ;
													{
														LA37_:;
