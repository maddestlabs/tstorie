...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -sUSE_SDL=3 -Os   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_wasm_core/@mlib@sansi_parser.nim.c.o /workspaces/telestorie/nimcache_wasm_core/@mlib@sansi_parser.nim.c */
...
LA115_: ;
						...
						eqsink___backendsZsdl3Zsdl95canvas_u203((&buffer_1.cells.p->data[idx_1]), T118_);
						{
