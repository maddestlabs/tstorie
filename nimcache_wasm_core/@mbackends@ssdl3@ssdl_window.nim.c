...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -sUSE_SDL=3 -Os   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_wasm_core/@mbackends@ssdl3@ssdl_window.nim.c.o /workspaces/telestorie/nimcache_wasm_core/@mbackends@ssdl3@ssdl_window.nim.c */
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = (tySequence__c5tLc28JqMkmyDqVscozRw_Content*) newSeqPayload(0, sizeof(tyObject_SDLInputEvent__59b7dApF39bbgeaxejw3Dfcg), NIM_ALIGNOF(tyObject_SDLInputEvent__59b7dApF39bbgeaxejw3Dfcg));
	nimZeroMem((void*)(&event_1), sizeof(SDL_Event));
	{
		while (1) {
			...
			case ((NU32)515):
			{
				...
				nimZeroMem((void*)(&T5_), sizeof(tyObject_SDLInputEvent__59b7dApF39bbgeaxejw3Dfcg));
			...
			case ((NU32)768):
			{
				...
				scancode_1 = getEventScancode__backendsZsdl3Zsdl95input_u4345((&event_1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				keycode_1 = scancodeToKeyCode__backendsZsdl3Zsdl95input_u4101(scancode_1);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimZeroMem((void*)(&T7_), sizeof(tyObject_SDLInputEvent__59b7dApF39bbgeaxejw3Dfcg));
			...
			case ((NU32)769):
			{
				...
				scancode_2 = getEventScancode__backendsZsdl3Zsdl95input_u4345((&event_1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				keycode_2 = scancodeToKeyCode__backendsZsdl3Zsdl95input_u4101(scancode_2);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimZeroMem((void*)(&T9_), sizeof(tyObject_SDLInputEvent__59b7dApF39bbgeaxejw3Dfcg));
			...
			case ((NU32)514):
			{
				...
				(void)(T11_);
				(*canvas_p0).width = ((NI) (w_1));
				(*canvas_p0).height = ((NI) (h_1));
				nimZeroMem((void*)(&T12_), sizeof(tyObject_SDLInputEvent__59b7dApF39bbgeaxejw3Dfcg));
			...
			default:
			{
				...
				nimZeroMem((void*)(&T14_), sizeof(tyObject_SDLInputEvent__59b7dApF39bbgeaxejw3Dfcg));
