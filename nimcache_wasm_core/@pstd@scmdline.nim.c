...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -sUSE_SDL=3 -Os   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_wasm_core/@pstd@scmdline.nim.c.o /workspaces/telestorie/nimcache_wasm_core/@pstd@scmdline.nim.c */
...
LA5_: ;
	{
		...
		(*T9_).Sup.Sup.name = "IndexDefect";
		{
			...
			eqwasMoved___system_u2639((&colontmpD_));
...
LA12_: ;
		{
			...
			if (nimSubInt(cmdCount, ((NI32)1), &TM__MZPGKsURfItHSi3RvnOT8Q_11)) { raiseOverflow(); goto LA8_;
			};
			colontmpD__4 = dollar___systemZdollars_u29((NI32)(TM__MZPGKsURfItHSi3RvnOT8Q_11));
			if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
...
{nimErr_ = nimErrorFlag();
	...
	i_1 = ((NI)0);
	a_1 = TM__MZPGKsURfItHSi3RvnOT8Q_13;
	{
		while (1) {
			NimStringV2 T26_;
...
LA10_: ;
			...
			case 34:
			{
				...
				if (nimAddInt(i_1, ((NI)1), &TM__MZPGKsURfItHSi3RvnOT8Q_15)) { raiseOverflow(); goto LA1_;
				};
...
LA16_: ;
						...
						if (nimAddInt(i_1, ((NI)1), &TM__MZPGKsURfItHSi3RvnOT8Q_17)) { raiseOverflow(); goto LA1_;
						};
...
LA25_: ;
						...
						nimAddCharV1((&a_1), c_p0.p->data[i_1]);
						if (nimAddInt(i_1, ((NI)1), &TM__MZPGKsURfItHSi3RvnOT8Q_19)) { raiseOverflow(); goto LA1_;
						};
