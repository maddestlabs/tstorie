...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -pthread   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_test/@msrc@stypes.nim.c.o /workspaces/telestorie/nimcache_test/@msrc@stypes.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___backendsZsdl3Zsdl95canvas_u240)(tySequence__hETDgeXECLenIIi9aRQgjOA* dest_p0, tySequence__hETDgeXECLenIIi9aRQgjOA src_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___srcZlayers_u44)(tyObject_LayercolonObjectType___GgVqgNTBauiDGOm9bCEWiYQ* dest_p0) {
	eqdestroy___backendsZsdl3Zsdl95canvas_u237((*dest_p0).buffer.cells);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___srcZappstate_u37)(tyObject_AppStatecolonObjectType___jrSyZ9aZLwUQnIb5lEtzv8Q* dest_p0) {
 ...
 deallocShared((*dest_p0).inputParser.utf8Buffer.p);
	...
	eqdestroy___backendsZsdl3Zsdl95canvas_u237((*dest_p0).previousBuffer.cells);
	eqdestroy___backendsZsdl3Zsdl95canvas_u237((*dest_p0).currentBuffer.cells);
}
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___srcZlayers_u25)(tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw* dest_p0, tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw* src_p1) {
	...
	if ((*dest_p0).cells.p != (*src_p1).cells.p) {	eqdestroy___backendsZsdl3Zsdl95canvas_u237((*dest_p0).cells);
	}
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___srcZlayers_u19)(tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw* dest_p0, tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw* src_p1) {
	(*dest_p0).width = (*src_p1).width;
	(*dest_p0).height = (*src_p1).height;
	eqcopy___backendsZsdl3Zsdl95canvas_u240((&(*dest_p0).cells), (*src_p1).cells);
	(*dest_p0).clipX = (*src_p1).clipX;
	(*dest_p0).clipY = (*src_p1).clipY;
	(*dest_p0).clipW = (*src_p1).clipW;
	(*dest_p0).clipH = (*src_p1).clipH;
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___backendsZsdl3Zsdl95canvas_u186)(tyObject_Cell__cmvwxiDU9cRtyqddD9c1iMTA* dest_p0, tyObject_Cell__cmvwxiDU9cRtyqddD9c1iMTA src_p1) {
	eqcopy___system_u2692((&(*dest_p0).ch), src_p1.ch);
	(*dest_p0).style.fg.r = src_p1.style.fg.r;
	(*dest_p0).style.fg.g = src_p1.style.fg.g;
	(*dest_p0).style.fg.b = src_p1.style.fg.b;
	(*dest_p0).style.bg.r = src_p1.style.bg.r;
