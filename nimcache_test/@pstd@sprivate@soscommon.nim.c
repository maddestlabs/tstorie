...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -pthread   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_test/@pstd@sprivate@soscommon.nim.c.o /workspaces/telestorie/nimcache_test/@pstd@sprivate@soscommon.nim.c */
...
{	nimZeroMem((void*)(&res_1), sizeof(struct stat));
	nimlf_(126, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/std/private/oscommon.nim");	nimln_(111);	nimln_(126);	T1_ = (NIM_BOOL)0;
	T2_ = (int)0;
