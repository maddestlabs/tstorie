...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -pthread   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_test/@mlib@sansi_parser.nim.c.o /workspaces/telestorie/nimcache_test/@mlib@sansi_parser.nim.c */
		...
		nimln_(239);		while (1) {
			...
			case 58:
			{
				nimln_(247);				{
					...
					nimlf_(1699, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system.nim");					eqsink___system_u2698((&numStr_1), TM__7VUp4HkTkBAUceCS9cYfV1A_13);
				}
				goto LA19_;
LA21_: ;
				{
...
LA9_: ;
					...
					nimln_(450);					tmpTuple_1 = parseAnsiSequence__libZansi95parser_u102(text_p0, i_1);
...
LA9_: ;
					if (!T6_) goto LA10_;
					nimZeroMem((void*)(&tmpTuple_1), sizeof(tyTuple__JTIDOE9coS9asgfLHY5jZqMA));
					nimln_(514);					tmpTuple_1 = parseAnsiSequence__libZansi95parser_u102(text_p0, i_1);
					if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
					seqLen_1 = tmpTuple_1.Field0;
					nimln_(515);					{
...
LA12_: ;
 ...
 deallocShared(colontmpD_.p);
					...
					nimlf_(306, "/workspaces/telestorie/lib/ansi_parser.nim");					tmpTuple_1 = parseAnsiSequence__libZansi95parser_u102(ansiContent_p0, bytePos_1);
					if (NIM_UNLIKELY(*nimErr_)) goto LA15_;
					seqLen_1 = tmpTuple_1.Field0;
...
LA115_: ;
						...
						nimlf_(934, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system.nim");						eqsink___backendsZsdl3Zsdl95canvas_u192((&buffer_1.cells.p->data[idx_1]), T118_);
