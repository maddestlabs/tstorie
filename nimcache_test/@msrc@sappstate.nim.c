...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -pthread   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_test/@msrc@sappstate.nim.c.o /workspaces/telestorie/nimcache_test/@msrc@sappstate.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(void, setTargetFps__srcZappstate_u373)(tyObject_AppStatecolonObjectType___jrSyZ9aZLwUQnIb5lEtzv8Q* state_p0, NF fps_p1) {
	...
	nimlf_(44, "/workspaces/telestorie/src/appstate.nim");	(*state_p0).targetFps = fps_p1;
	popFrame();
}
static N_INLINE(void, quit__system_u8204)(NI errorcode_p0) {
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(75, "/workspaces/telestorie/src/appstate.nim");	T2_[0] = TM__q7pryhnR86ABMsp6089b69bw_3;
...
LA6_: ;
		if (!T5_) goto LA7_;
		nimln_(77);		echoBinSafe(TM__q7pryhnR86ABMsp6089b69bw_6, 1);
		nimln_(78);		quit__system_u8204(((NI)1));
	}
LA7_: ;
	nimln_(79);	(*state_p0).termWidth = newWidth_p1;
	nimln_(80);	(*state_p0).termHeight = newHeight_p2;
	nimlf_(27, "/workspaces/telestorie/src/layers.nim");	nimlf_(81, "/workspaces/telestorie/src/appstate.nim");	nimZeroMem((void*)(&T9_), sizeof(tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw));
	newTermBuffer__backendsZterminalZtermbuffer_u4(newWidth_p1, newHeight_p2, (&T9_));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimlf_(27, "/workspaces/telestorie/src/layers.nim");	eqsink___srcZlayers_u25((&(*state_p0).currentBuffer), (&T9_));
	nimlf_(82, "/workspaces/telestorie/src/appstate.nim");	nimZeroMem((void*)(&T10_), sizeof(tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw));
	newTermBuffer__backendsZterminalZtermbuffer_u4(newWidth_p1, newHeight_p2, (&T10_));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimlf_(27, "/workspaces/telestorie/src/layers.nim");	eqsink___srcZlayers_u25((&(*state_p0).previousBuffer), (&T10_));
	nimlf_(83, "/workspaces/telestorie/src/appstate.nim");	resizeLayers__srcZlayers_u2334(state_p0, newWidth_p1, newHeight_p2);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimln_(84);	echoBinSafe(TM__q7pryhnR86ABMsp6089b69bw_8, 1);
	{
		LA1_:;
	}
	{
...
{	nimlf_(49, "/workspaces/telestorie/src/appstate.nim");	if (nimAddInt((*state_p0).frameCount, ((NI)1), &TM__q7pryhnR86ABMsp6089b69bw_10)) { raiseOverflow(); goto BeforeRet_;
	};
	(*state_p0).frameCount = (NI)(TM__q7pryhnR86ABMsp6089b69bw_10);
	nimln_(50);	pluseq___pureZstrutils_u2602((&(*state_p0).totalTime), deltaTime_p1);
	nimln_(53);	{
		if (!(0.5 <= ((NF)((*state_p0).totalTime) - (NF)((*state_p0).lastFpsUpdate)))) goto LA3_;
		nimln_(54);		(*state_p0).fps = ((NF)(1.0) / (NF)(deltaTime_p1));
		nimln_(55);		(*state_p0).lastFpsUpdate = (*state_p0).totalTime;
	}
LA3_: ;
	}BeforeRet_: ;
	popFrame();
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(15);	T2_[0] = TM__q7pryhnR86ABMsp6089b69bw_12;
	...
	T2_[3] = colontmpD__2;
	echoBinSafe(T2_, 4);
	nimln_(16);	result = new__srcZappstate_u7();
	nimln_(17);	(*result).termWidth = width_p0;
	nimln_(18);	(*result).termHeight = height_p1;
	nimln_(19);	T3_[0] = TM__q7pryhnR86ABMsp6089b69bw_15;
	...
	T3_[3] = colontmpD__4;
	echoBinSafe(T3_, 4);
	nimlf_(27, "/workspaces/telestorie/src/layers.nim");	nimlf_(20, "/workspaces/telestorie/src/appstate.nim");	nimZeroMem((void*)(&T4_), sizeof(tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw));
	newTermBuffer__backendsZterminalZtermbuffer_u4(width_p0, height_p1, (&T4_));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimlf_(27, "/workspaces/telestorie/src/layers.nim");	eqsink___srcZlayers_u25((&(*result).currentBuffer), (&T4_));
	nimlf_(21, "/workspaces/telestorie/src/appstate.nim");	T5_[0] = TM__q7pryhnR86ABMsp6089b69bw_18;
	...
	T5_[3] = colontmpD__6;
	echoBinSafe(T5_, 4);
	nimlf_(27, "/workspaces/telestorie/src/layers.nim");	nimlf_(22, "/workspaces/telestorie/src/appstate.nim");	nimZeroMem((void*)(&T6_), sizeof(tyObject_TermBuffer__a0me0i7S30c79coeAcFBkWw));
	newTermBuffer__backendsZterminalZtermbuffer_u4(width_p0, height_p1, (&T6_));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimlf_(27, "/workspaces/telestorie/src/layers.nim");	eqsink___srcZlayers_u25((&(*result).previousBuffer), (&T6_));
	nimlf_(23, "/workspaces/telestorie/src/appstate.nim");	echoBinSafe(TM__q7pryhnR86ABMsp6089b69bw_20, 1);
	nimln_(24);	(*result).colorSupport = ((NI)16777216);
	nimln_(25);	(*result).running = NIM_TRUE;
	nimlf_(40, "/workspaces/telestorie/src/layers.nim");	T7_.len = 0; T7_.p = NIM_NIL;
	...
	nimlf_(27, "/workspaces/telestorie/src/appstate.nim");	(*result).targetFps = 60.0;
	nimln_(28);	nimZeroMem((void*)(&T8_), sizeof(tyObject_TerminalInputParser__GHUTtss0GjS80F0ZztO53Q));
	newTerminalInputParser__srcZinput_u370((&T8_));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	eqsink___srcZappstate_u343((&(*result).inputParser), (&T8_));
	nimln_(29);	(*result).lastMouseX = ((NI)0);
	nimln_(30);	(*result).lastMouseY = ((NI)0);
	nimln_(31);	(*result).fps = 60.0;
	nimln_(32);	(*result).frameCount = ((NI)0);
	nimln_(33);	(*result).totalTime = 0.0;
	nimln_(34);	(*result).lastFpsUpdate = 0.0;
	nimln_(35);	(*result).audioSystemPtr = NIM_NIL;
	nimln_(36);	colontmp_ = ((NU8)0);
	colontmp__2 = ((NU8)0);
	colontmp__3 = ((NU8)0);
