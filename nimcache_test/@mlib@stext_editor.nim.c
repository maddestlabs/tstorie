...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -fno-strict-aliasing -pthread   -I/home/codespace/.choosenim/toolchains/nim-2.2.6/lib -I/workspaces/telestorie -o /workspaces/telestorie/nimcache_test/@mlib@stext_editor.nim.c.o /workspaces/telestorie/nimcache_test/@mlib@stext_editor.nim.c */
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(191);	{
		...
		nimln_(192);		T6_ = newEditorLine__libZtext95editor_u39(TM__ju9cg9cywhFyBl2l4t4KQoNA_3);
			...
			nimln_(268);			L_1 = content_p0.len;
			{
				nimln_(269);				while (1) {
					...
					nimln_(197);					{
						...
						nimln_(198);						T15_ = newEditorLine__libZtext95editor_u39(currentLine_1);
						...
						nimlf_(1699, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system.nim");						eqsink___system_u2698((&currentLine_1), TM__ju9cg9cywhFyBl2l4t4KQoNA_5);
					}
					goto LA11_;
LA13_: ;
					{
...
LA19_: ;
		...
		nimlf_(204, "/workspaces/telestorie/lib/text_editor.nim");		T21_ = newEditorLine__libZtext95editor_u39(currentLine_1);
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(212);	{
		...
		nimln_(213);		T7_ = newEditorLine__libZtext95editor_u39(TM__ju9cg9cywhFyBl2l4t4KQoNA_9);
	...
	{
		{
			...
			L_1 = T10_;
			{
				nimln_(251);				while (1) {
					...
					nimln_(216);					T13_ = newEditorLine__libZtext95editor_u39((*line_1));
...
LA4_: ;
	...
	nimln_(141);	if ((newSize_1) < ((NI)0) || (newSize_1) > ((NI)2147483647)){ raiseRangeErrorI(newSize_1, ((NI)0), ((NI)2147483647)); goto LA1_;
	}
...
LA17_: ;
	...
	nimlf_(300, "/workspaces/telestorie/lib/text_editor.nim");	T23_ = newEditorLine__libZtext95editor_u39(beforeText_1);
	...
	nimlf_(301, "/workspaces/telestorie/lib/text_editor.nim");	T24_ = newEditorLine__libZtext95editor_u39(afterText_1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___libZtext95editor_u1370)(tyTuple__lCkPSZ8mSjw9ar0f2jTiKGw* dest_p0) {
	eqdestroy___system_u3767((*dest_p0).Field0);
...
LA122_: ;
						...
						eqcopy___system_u2692((&line_1), minimapData_1.Field0.p->data[i_6]);
		...
		nimlf_(128, "/home/codespace/.choosenim/toolchains/nim-2.2.6/lib/system/iterators_1.nim");		i_2 = ((NI)0);
		{
			nimln_(129);			while (1) {
				...
				nimln_(1032);				{
					...
					eqcopy___system_u2692((&line_1), minimapData_1.Field0.p->data[i_1]);
